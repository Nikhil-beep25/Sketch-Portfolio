      ...
      <main className="project-details blueprint-bg" id="main-content">
        ...
        <div className="project-details__content">
          <div className="pd-dossier">
            ...
            {/* BLOCK 1: INDUSTRIAL TITLE BLOCK */}
            ...
            {/* BLOCK 2: PRODUCTION INTERFACE PREVIEW */}
            ...
            {/* BLOCK 3: CASE STUDY NARRATIVE (PROBLEM & SOLUTION) */}
            ...
            {/* BLOCK 4: KEY METRICS & ENGINEERING IMPACT */}
            ...
            {/* BLOCK 5: ENGINEERING FIELD NOTES & HIGHLIGHTS */}
            {project.highlights && (
